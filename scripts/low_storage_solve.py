...
# Set up logging
log_file_path = f"{origin_path}/low_storage.log"
...
for network_file in network_files:
    ...
    for carrier in ['hydro', 'PHS', 'H2', 'battery']:
        ...
        #network.storage_units.loc[storage_units.index, 'p_nom_extendable'] = False
    ...
    output_filename = os.path.join(output_directory, os.path.basename(network_file).replace(".nc", "_LS_solved.nc"))
